public class  ViewDeal{
    ...
    public Contact getContact(){
         Contact contact= [Select c.Title, c.Salutation,  
                          ...
                          c.Acceptance_Rate__c From Contact c where id= :contactId limit 100];  
              return contact;             
      }
    ...
    //public ViewDeal(){
      ...
      //  this.setCon= new ApexPages.StandardSetController( [Select Name, 
        //                       Valid_Through__c, Available_Deals__c From Deal__c d] );
    ...
    public List<DisplayDeals> getDeals(){
        ...
        if(dealList==null){
            ...
            for(sObject r : this.setCon.getRecords()){
            	Deal__c item = (Deal__c)r;
                dealList.add(new DisplayDeals(item));
            }
            //for(Deal__c item: this.setCon.getRecords())
            //{
              // dealList.add(new DisplayDeals(item));
            //}
        }
