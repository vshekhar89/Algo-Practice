public class  ViewDeal{
    ...
    public Contact getContact(){
     ...
     public ApexPages.StandardSetController setCon {
        get {
            if(setCon == null) {
                setCon = new ApexPages.StandardSetController(Database.getQueryLocator([Select Name, Valid_Through__c, Available_Deals__c From Deal__c d 
    ...
    public List<DisplayDeals> getDeals(){
        ...
        if(dealList==null){
          setCon.setpagesize(5);
            ...
            for(Deal__c item : (List<Deal__c>)setCon.getRecords()){
